...
import (
	...
	"github.com/lxt1045/atlas-cmd-internal/cmdstate"
	cmdmigrate "github.com/lxt1045/atlas-cmd-internal/migrate"
	"github.com/lxt1045/atlas-cmd-internal/migratelint"
...
var (
	...
	// "-X 'github.com/lxt1045/atlas-cmd-internal/cmdapi.flavor=community'"
	flavor string

	// version holds Atlas version. When built with cloud packages should be set by build flag, e.g.
	// "-X 'github.com/lxt1045/atlas-cmd-internal/cmdapi.version=v0.1.2'"
	version string
	...
	// "-X 'github.com/lxt1045/atlas-cmd-internal/cmdapi.license=${license}'"
	license = `LICENSE
