	...
	tests := []struct {
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/lxt1045/atlas-cmd-internal/cmdapi.version=v1.2.3",
		...
		},
		{
			...
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/lxt1045/atlas-cmd-internal/cmdapi.version=v0.3.0-6539f2704b5d-canary",
				"ariga.io/atlas/cmd/atlas",
				"version",
			),
			expected: "atlas community version v0.3.0-6539f2704b5d-canary\nhttps://github.com/ariga/atlas/releases/latest\n",
		},
		{
			name: "flavor",
			cmd: exec.Command("go", "run",
				"-ldflags",
				"-X github.com/lxt1045/atlas-cmd-internal/cmdapi.flavor=flavor",
				"ariga.io/atlas/cmd/atlas",
				"version",
			),
